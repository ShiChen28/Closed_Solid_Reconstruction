...
modifications = {
    ...
    struct('edge_idx',4,'translation',[-1.5,0],'rotation',0),   
    struct('edge_idx',4,'translation',[-2.5,0],'rotation',0),   
    struct('edge_idx',4,'translation',[1.0,0],'rotation',0),   
    struct('edge_idx',4,'translation',[2.0,0],'rotation',0),   
};
